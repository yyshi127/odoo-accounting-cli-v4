"""Narrow invoice ports backed by fixed local Odoo bridge actions."""
...
class OdooInvoicePort:
    """Expose only the three fixed read actions used by invoice capabilities."""
    ...
    def user_id(self) -> int:
        if self._user_id is None:
            raise ValueError("No verified Odoo invoice result has been read.")
    ...
    def _invoke(
        ...
        *,
        ...
        if (
            ...
            raise ValueError("The Odoo bridge returned an invalid invoice result.")
