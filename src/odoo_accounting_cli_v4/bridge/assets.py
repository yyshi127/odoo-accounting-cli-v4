"""Narrow bridge port for the three fixed-asset reads."""
...
class OdooAssetPort:
    ...
    def user_id(self) -> int:
        if self._user_id is None:
            raise ValueError("No verified Odoo asset page has been read.")
    ...
    def read(
        ...
        *,
        ...
        if capability_id not in CAPABILITY_IDS:
            raise ValueError("Unsupported asset capability.")
        self._user_id = None
        ...
        if not _valid_page(page):
            raise ValueError("The Odoo bridge returned an invalid asset page.")
