"""Narrow bridge port for inventory-operation reads."""
...
class OdooInventoryOperationsPort:
    ...
    def user_id(self) -> int:
        if self._user_id is None:
            raise ValueError("No verified Odoo inventory-operation page has been read.")
    ...
    def read(
        ...
        *,
        ...
        if capability_id not in CAPABILITY_IDS:
            raise ValueError("Unsupported inventory-operation capability.")
        self._user_id = None
        ...
        if not _valid_page(page):
            raise ValueError(
                "The Odoo bridge returned an invalid inventory-operation page."
            )
