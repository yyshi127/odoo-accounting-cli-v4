"""Narrow port for the fixed reconciliation-candidate bridge action."""
...
class OdooReconciliationCandidatesPort:
    """Read only the default Journal Items to reconcile candidate page."""
    ...
    def user_id(self) -> int:
        if self._user_id is None:
            raise ValueError("No verified Odoo reconciliation-candidate page was read.")
