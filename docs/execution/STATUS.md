...
- G3: in progress (102-ID capability matrix frozen; fourteen read implementations
...
- G5: in progress (real dual-environment bridge and fourteen read vertical slices
