...
- G3: in progress (102-ID capability matrix frozen; sixteen read implementations
...
- G5: in progress (real dual-environment bridge and sixteen read vertical slices
