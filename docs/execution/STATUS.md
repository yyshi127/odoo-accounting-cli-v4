...
- G3: in progress (102-ID capability matrix frozen; seventeen read implementations
...
- G5: in progress (real dual-environment bridge and seventeen read vertical slices
